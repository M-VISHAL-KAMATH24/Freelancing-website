...
const App = () => {
  ...
  const apiUrl = import.meta.env.VITE_API_URL || 'https://freelancing-website-122.onrender.com';
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/chat/:sellerId" element={<Chat apiUrl={apiUrl} />} />
          <Route path="/chat/seller" element={<Chat apiUrl={apiUrl} />} />
        </Routes>
      </div>
    </Router>
  );
